...
export default function Home() {
  ...
  <div className='lg:flex-row flex flex-col justify-center mb-5 items-center lg:px-32 px-6 mt-12 text-white'>
    <div className='lg:w-[43%] sm:w-[60%] w-full md:w-1/2 relative'>
      ...
      <picture className='absolute bottom-[14.7%] w-[71%] start-[17.9%]'><Image width={453} height={604} priority src={nasserImag} alt="Nasser Hussein photo" /></picture>
    </div>
