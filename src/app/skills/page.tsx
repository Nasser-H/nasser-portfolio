...
export default function Skills() {
  ...
  return <> 
    <div className='text-center mt-16 mb-10'>
        ...
        <div className='flex flex-wrap justify-start items-center w-[50%] mx-auto gap-y-10 mb-14'>
            {skills.map((skill, index)=>
                <div key={index} className='text-white/80 flex justify-center items-center px-2 w-full sm:w-1/2 lg:w-1/3'>
        ...
        <div className='flex flex-wrap justify-center items-center w-[50%] mx-auto gap-y-10'>
